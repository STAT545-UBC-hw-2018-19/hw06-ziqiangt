...
<script type="application/json" data-for="htmlwidget-0ae479c0ed595f1fef67">{"x":{"html":"<ul>\n  <li>I<span class='match'>\\<\/span>AM<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
#### Q2

How would you match the sequence "'? Answer: Both ' and  need to be escaped in regex.
...
<script type="application/json" data-for="htmlwidget-9007411d0b58a0d57272">{"x":{"html":"<ul>\n  <li><span class='match'>\"'\\<\/span>AM<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
#### Q3

What patterns will the regular expression ...... match? How would you represent it as a string? Answer: It match ".anycharacter.anycharacter.anycharacter"
...
<script type="application/json" data-for="htmlwidget-9dec1af2fe772fb3c7df">{"x":{"html":"<ul>\n  <li>I<span class='match'>.A.M.z<\/span>...xxx<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
### 14.3.2.1 Exercises

#### Q1

How would you match the literal string "$^$"? Answer: Both $ and ^ need to be escaped in regex.
...
<script type="application/json" data-for="htmlwidget-81be7c9802588d066810">{"x":{"html":"<ul>\n  <li><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
#### Q2
...
<script type="application/json" data-for="htmlwidget-cf0b727db023b47299cc">{"x":{"html":"<ul>\n  <li><span class='match'>y<\/span>ear<\/li>\n  <li><span class='match'>y<\/span>es<\/li>\n  <li><span class='match'>y<\/span>esterday<\/li>\n  <li><span class='match'>y<\/span>et<\/li>\n  <li><span class='match'>y<\/span>ou<\/li>\n  <li><span class='match'>y<\/span>oung<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
End with “x”.
...
<script type="application/json" data-for="htmlwidget-71f9df11670818816a72">{"x":{"html":"<ul>\n  <li>bo<span class='match'>x<\/span><\/li>\n  <li>se<span class='match'>x<\/span><\/li>\n  <li>si<span class='match'>x<\/span><\/li>\n  <li>ta<span class='match'>x<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
...
<script type="application/json" data-for="htmlwidget-0d99614205c3f55cbfda">{"x":{"html":"<ul>\n  <li><span class='match'>act<\/span><\/li>\n  <li><span class='match'>add<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
...
<script type="application/json" data-for="htmlwidget-0b9437c237fd5791d36b">{"x":{"html":"<ul>\n  <li><span class='match'>by<\/span><\/li>\n  <li><span class='match'>dry<\/span><\/li>\n  <li><span class='match'>fly<\/span><\/li>\n  <li><span class='match'>mrs<\/span><\/li>\n  <li><span class='match'>try<\/span><\/li>\n  <li><span class='match'>why<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
...
<script type="application/json" data-for="htmlwidget-bec738a9d1cd91076e21">{"x":{"html":"<ul>\n  <li><span class='match'>bed<\/span><\/li>\n  <li>hund<span class='match'>red<\/span><\/li>\n  <li><span class='match'>red<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
End with ing or ise.
...
Write a regular expression that matches a word if it’s probably written in British English, not American English. Answer: According to [oxfordinternationalenglish](https://www.oxfordinternationalenglish.com/differences-in-british-and-american-spelling/),British English words ending in ‘our’ usually end in ‘or’ in American English. Here is an example:
...
<script type="application/json" data-for="htmlwidget-a8958d10c62de71fe34d">{"x":{"html":"<ul>\n  <li>col<span class='match'>our<\/span><\/li>\n  <li>hum<span class='match'>our<\/span><\/li>\n  <li>neighb<span class='match'>our<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
#### Q5

Create a regular expression that will match telephone numbers as commonly written in your country. Answer: In my country, China, the telephone number starts with +86 and have 11 digits (except +86) in total.
...
<script type="application/json" data-for="htmlwidget-ee2ccb977ec79edd6a9e">{"x":{"html":"<ul>\n  <li><span class='match'>+8613777705661<\/span><\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
### Exercises 14.3.4.1

#### Q1

Describe the equivalents of ?, +, \* in {m,n} form. Answer:
...
<tr class="even">
<td><code>\\{.+\\}</code></td>
<td>{at least one character} for example: {a}, {abd}</td>
</tr>
<tr class="odd">
<td><code>\d{4}-\d{2}-\d{2}</code></td>
<td>matches in the format dddd-dd-dd, where d is digit. For example, &quot;1111-22-33&quot;.</td>
</tr>
<tr class="even">
<td>'\\{4}'</td>
<td>matches four back slashes</td>
</tr>
</tbody>
</table>
...
<script type="application/json" data-for="htmlwidget-77648c7b406659be672e">{"x":{"html":"<ul>\n  <li>b<span class='match'>eau<\/span>ty<\/li>\n  <li>obv<span class='match'>iou<\/span>s<\/li>\n  <li>prev<span class='match'>iou<\/span>s<\/li>\n  <li>q<span class='match'>uie<\/span>t<\/li>\n  <li>ser<span class='match'>iou<\/span>s<\/li>\n  <li>var<span class='match'>iou<\/span>s<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
...
<tr class="odd">
<td>(.)</td>
<td>match a character followed with . e.g. &quot;x&quot;</td>
</tr>
<tr class="even">
<td>&quot;(.)(.)\2\1&quot;</td>
<td>match the two characters followed with and reversal. e.g. &quot;xyyx&quot;</td>
</tr>
<tr class="odd">
<td><code>(..)\1</code></td>
<td>match a pair of characters followed with . e.g. &quot;ab&quot;</td>
</tr>
<tr class="even">
<td>&quot;(.).\1.\1&quot;</td>
<td>match in the format &quot;x anycharacter x anycharacter x&quot;. e.g. &quot;abaxa&quot;</td>
</tr>
<tr class="odd">
<td>&quot;(.)(.)(.).*\3\2\1&quot;</td>
<td>match three characters appears at the beginning, then follows by any characters (0 or more), then the reversal of the begining three characters. For example, &quot;abcxxcba&quot;.</td>
</tr>
</tbody>
</table>
...
Are there any words that contain at least one of each different vowel? Answer: In orer to use single regular expression, we need to wirte 5*4*3*2*1=120 conditions. For example, we need to match "abc"" disorderly. There are 6 conditions: abc, acd, bac, bca, cab, cba. It is therefore seems impossible to use a single regular expression to finish this question. However, we could use "?=" which is a positive lookahead, a type of zero-width assertion to solve this problem.
...
<script type="application/json" data-for="htmlwidget-fff33db077c1e22c31a4">{"x":{"html":"<ul>\n  <li>It is hard to erase <span class='match'>blue<\/span> or <span class='match'>red<\/span> ink.<\/li>\n  <li>The <span class='match'>green<\/span> light in the brown box flicke<span class='match'>red<\/span>.<\/li>\n  <li>The sky in the west is tinged with <span class='match'>orange<\/span> <span class='match'>red<\/span>.<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
...
<script type="application/json" data-for="htmlwidget-dee061ee47d036bf0735">{"x":{"html":"<ul>\n  <li>It is hard to erase <span class='match'>blue<\/span> or <span class='match'>red<\/span> ink.<\/li>\n  <li>The sky in the west is tinged with <span class='match'>orange<\/span> <span class='match'>red<\/span>.<\/li>\n<\/ul>"},"evals":[],"jsHooks":[]}</script>
<!--/html_preserve-->
#### Q2
...
Which of those strings are still words? Answer: We can use "intersect" to find two sets that they have in common.
...
Why is it better to split up by boundary("word") than " "? Answer: Since use " " will bring other symbol rather a pure word. Here is an example.
...
What does splitting with an empty string ("") do? Experiment, and then read the documentation. Answer: It will split every single character. This is same as boundary('character'). Here is an example.
...
Find the stringi functions that fullfill the following requirements. Count the number of words.
...
<tbody>
<tr class="odd">
<td>stri_duplicated()</td>
<td>determines which strings in a character vector are duplicates of other elements.</td>
</tr>
<tr class="even">
<td>stri_duplicated_any()</td>
<td>determines if there are any duplicated strings in a character vector.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td>stri_rand_strings()</td>
<td>Generates (pseudo)random strings of desired lengths</td>
</tr>
<tr class="even">
<td>stri_rand_lipsum()</td>
<td>Generates (pseudo)random lorem ipsum text consisting of a given number of text paragraphs.</td>
</tr>
</tbody>
</table>
...
```
    ...
    ## Lorem ipsum dolor sit amet, cursus curabitur, odio sed enim eu sociis. Porttitor, egestas pulvinar viverra. Eros vestibulum cubilia erat viverra nullam massa. Lectus in condimentum. Amet ad ac sollicitudin, pellentesque torquent amet. Posuere volutpat. Augue mollis, luctus, bibendum, magna luctus nascetur sapien tempor et hendrerit efficitur, sed. Amet ante libero quam velit faucibus dolor eget erat ligula. Vulputate eros amet class purus praesent. Montes ut et aliquet nulla rutrum amet elementum libero et leo gravida. Duis ut varius sed convallis dictum.
    ## 
    ## Libero hac, libero nisi sed integer. Odio aptent senectus rutrum et eu ornare velit mauris et vitae tempor vestibulum hac. Magnis vitae commodo quam facilisis. Hendrerit amet sit maecenas semper fusce ante torquent nulla viverra. At vulputate sed at. Efficitur, habitasse sit nec sed mauris, sed sem sit. Quam erat augue accumsan diam volutpat dictum, rutrum molestie sapien. Nulla cursus ipsum. Quis ultrices varius sollicitudin in blandit? Erat id vitae curae risus curabitur. Ex gravida tempus mattis finibus lectus in. Amet tempor platea tortor lectus vitae, ipsum, non lorem cras habitasse. Vehicula vitae ornare mauris sed morbi magna morbi molestie sapien. Ligula donec montes ligula inceptos scelerisque.

#### Q2

How do you control the language that stri\_sort() uses for sorting? Answer: We can use opts\_collator to control. Here is an example.
...
![](hw06_files/figure-markdown_github/unnamed-chunk-59-1.png)
...
![](hw06_files/figure-markdown_github/unnamed-chunk-60-1.png)
